...
class cmb_Meta_Box_PPS_field {
	...
	public function __construct( $field_args, $group_field = null ) {
		$this->object_id   = cmb_Meta_Box_PPS::get_object_id();
		$this->object_type = cmb_Meta_Box_PPS::get_object_type();
	...
	public function get_data( $field_id = '', $args = array() ) {
		...
		$data = 'options-page' === $type
			? cmb_Meta_Box_PPS::get_option( $id, $field_id )
	...
	public function update_data( $new_value, $single = true ) {
		...
		if ( 'options-page' === $type )
			return cmb_Meta_Box_PPS::update_option( $id, $field_id, $new_value, $single );
	...
	public function remove_data( $old = '' ) {
		...
		return 'options-page' === $type
			? cmb_Meta_Box_PPS::remove_option( $id, $field_id )
	...
	public function sanitization_cb( $meta_value ) {
		...
		$clean = new cmb_Meta_Box_PPS_Sanitize( $this, $meta_value );
		// Validation via 'cmb_Meta_Box_PPS_Sanitize' (with fallback filter)
	...
	public function field_timezone_offset() {
		return cmb_Meta_Box_PPS::timezone_offset( $this->field_timezone() );
	}
	...
	public function render_field() {
		...
		$this_type = new cmb_Meta_Box_PPS_types( $this );
		$this_type->render();
