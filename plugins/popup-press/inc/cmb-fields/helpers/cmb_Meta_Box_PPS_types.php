...
class cmb_Meta_Box_PPS_types {
	...
	public function select_timezone() {
		$this->field->args['default'] = $this->field->args( 'default' )
			...
			: cmb_Meta_Box_PPS::timezone_string();
	...
	public function file() {
		...
		$this->field = new cmb_Meta_Box_PPS_field( $args, $this->field->group );
		...
		if ( $meta_value && ! $_id_value ) {
			$_id_value = cmb_Meta_Box_PPS::image_id_from_url( esc_url_raw( $meta_value ) );
		}
	...
	public function oembed() {
		...
		'<div id="',$this->_id( '_status' ) ,'" class="cmb_media_status ui-helper-clearfix embed_wrap">';
			...
			if ( $meta_value = $this->field->escaped_value() ) {
				echo cmb_Meta_Box_PPS_ajax::get_oembed( $meta_value, $this->field->object_id, array(
