 ...
 * @since  1.0.0
 */
class cmb_Meta_Box_PPS_Show_Filters {
	...
	public static function check_id( $display, $meta_box ) {
		...
		$object_id = is_admin() ? cmb_Meta_Box_PPS::get_object_id() : @get_the_id();
	...
	public static function check_page_template( $display, $meta_box ) {
		...
		$object_id = cmb_Meta_Box_PPS::get_object_id();

		if ( ! $object_id || cmb_Meta_Box_PPS::get_object_type() !== 'post' )
			return false;
