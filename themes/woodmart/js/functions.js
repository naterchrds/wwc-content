...
(function($) {
    ...
    woodmartThemeModule = (function() {
        ...
        var woodmartTheme = {
            ...
            bootstrapTooltips: '.woodmart-tooltip, .product-actions-btns > a, .wrapp-battons .woodmart-buttons > div:not(.woodmart-add-btn) a, .wrapp-battons .woodmart-buttons .woodmart-add-btn, body:not(.catalog-mode-on) .woodmart-hover-base:not(.product-in-carousel) .woodmart-buttons > div:not(.woodmart-add-btn) a, body:not(.catalog-mode-on) .woodmart-hover-base.hover-width-small:not(.product-in-carousel) .woodmart-add-btn, .woodmart-hover-base .product-compare-button a',
        ...
        return {
            ...
            fixedHeaders: function(){
                ...
                var headerSpacer = function() {
                    ...
                    $('.header-spacing').height(getHeaderHeight());
                };
            ...
            bannersHover: function() {
                $(".promo-banner.hover-parallax").panr({
                    sensitivity: 20,
                    scale: false,
                    scaleOnHover: true,
                    scaleTo: 1.15,
            ...
            cookiesPopup: function() {
                if( $.cookie('woodmart_cookies') == 'accepted' ) return;
                ...
                var acceptCookies = function() {
                    ...
                    $.cookie('woodmart_cookies', 'accepted', { expires: 60, path: '/' } );
                };
            },
            ...
            menuOffsets: function() {
                ...
                var setOffset = function( li ) {
                    ...
                    var dropdownWidth = dropdown.outerWidth(),
                        ...
                        dropdownOffsetRight = screenWidth - dropdownOffset.left - dropdownWidth;
            ...
            blogLoadMore: function() {
                ...
                woodmartThemeModule.clickOnScrollButton( btnClass , false );
                            ...
                            if( items ) {
                                if( holder.hasClass('masonry-container') ) {
                                    ...
                                    holder.imagesLoaded().progress(function() {
                                        ...
                                        woodmartThemeModule.clickOnScrollButton( btnClass , true );
                                    });
                                } else {
                                    holder.append(items);
                                    woodmartThemeModule.clickOnScrollButton( btnClass , true );
            ...
            productsLoadMore: function() {
                ...
                woodmartThemeModule.clickOnScrollButton( woodmartTheme.shopLoadMoreBtn , false );
                ...
                $(document).off('click', '.woodmart-products-load-more').on('click', '.woodmart-products-load-more',  function(e) {
                    ...
                    loadProducts( 'load-more', atts, ajaxurl, action, dataType, method, paged, holder, $this, [], function(data) {
                        if( data.items ) {
                            ...
                            holder.imagesLoaded().progress(function() {
                                woodmartThemeModule.clickOnScrollButton( woodmartTheme.shopLoadMoreBtn , true );
                            });
            ...
            addToCartAllTypes: function() {
                if( ! woodmart_settings.ajax_add_to_cart ) return;
            ...
            cartWidget: function() {
                ...
                var closeWidget = function() {
                    $('.website-wrapper').removeClass('woodmart-wrapper-shifted');
                    $('body').removeClass('woodmart-cart-opened');
                };

                var openWidget = function() {
                    if ( isCart() ) return false;
                    $('.website-wrapper').addClass('woodmart-wrapper-shifted');
            ...
            btnsToolTips: function() {
                ...
                $bootstrapTooltips.tooltip({
                    ...
                    trigger : 'hover',
                    title: function() {
                        if( $(this).find('.added_to_cart').length > 0 ) return $(this).find('.added_to_cart').text();
                        return $(this).text();
                    }
                });
            ...
            searchFullScreen: function() {
                ...
                body.on('click', '.search-button > a', function(e) {
                    ...
                    if( $('.search-button').hasClass('woodmart-search-dropdown') ) return;
                ...
                body.on("click", ".woodmart-close-search, .main-header, .sticky-header, .topbar-wrapp, .main-page-wrapper", function(event) {
            ...
            woocommerceNotices: function() {
                var notices = '.woocommerce-error, .woocommerce-info, .woocommerce-message, div.wpcf7-response-output, #yith-wcwl-popup-message, .mc4wp-alert';
            ...
            AJAXRemoveFromCart: function() {
                $( document ).on('click', '.widget_shopping_cart .remove', function(e) {
                    ...
                    $product.addClass('removing-process');
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            _wpnonce: _wpnonce,
                            action: 'woodmart_remove_from_cart'
                        },
                        method: 'GET',
                        success:function( data ) {
                        ...
                        complete: function() {
                            $product.removeClass('removing-process');
                        }
                    });
                })
            },
