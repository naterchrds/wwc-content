 ...
 */
    ...
    $args = array(
        ...
        'menu_icon'            => WOODMART_ASSETS . '/images/theme-admin-icon.png', 
        'last_tab'             => '',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            //     'id'        => 'logo_width',
            //     'type'      => 'slider',
            //     'title'     => esc_html__('Logo container width (%)', 'woodmart'),
            //     'desc'      => esc_html__('Set width for logo area in the header. In percentages. It needs to calculate width for other blocks in the headers where logo is centered.', 'woodmart'),
            //     "default"   => 20,
            //     "min"       => 1,
            //     "step"      => 1,
            //     "max"       => 50,
            //     'display_value' => 'label',
            //     'required' => array(
            //          array('header','equals', array('logo-center','shop')),
            //     )
            // ),
            array(
                'id'        => 'logo_img_width',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            array (
                ...
                'subtitle' => esc_html__('Place here text you want to see in the left place of header top bar. You can use shortocdes. Ex.: [social_buttons]', 'woodmart'),
            ...
            array (
                ...
                'subtitle' => esc_html__('Place here text you want to see in the RIGHT part of header top bar. You can use shortocdes. Ex.: [social_buttons]', 'woodmart'),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            array (
                'id'       => 'shopping_cart',
                'type'     => 'select',
                'title'    => esc_html__('Shopping cart', 'woodmart'),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            array (
                ...
                'subtitle' => esc_html__('You can change menu style in header', 'woodmart'),
                'options'  => array(
                    'default' => 'Default',
                    'bordered' => 'Bordered',
                ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            array (
                'id'       => 'header_links',
                'type'     => 'switch',
                'title'    => esc_html__('"My account" links in the HEADER', 'woodmart'),
                'default' => 1
            ),
            array (
                'id'       => 'topbar_links',
                'type'     => 'switch',
                'title'    => esc_html__('"My account" links in the TOP BAR', 'woodmart'),
                'default' => 0
            ),
            array (
                'id'       => 'login_dropdown',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            array (
                ...
                'subtitle' => esc_html__('You can use shortocdes. Ex.: [social_buttons]', 'woodmart'),
