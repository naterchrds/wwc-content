...
class WOODMART_ImportVersion_base extends WOODMART_ImportVersion {
	...
	public function create_attributes() {
		...
		$wpdb->insert( $wpdb->prefix . 'woocommerce_attribute_taxonomies', $attribute_brand );
		do_action( 'woocommerce_attribute_added', $wpdb->insert_id, $attribute_brand );

		flush_rewrite_rules();
		delete_transient( 'wc_attribute_taxonomies' );

		$register_function = 'register' .'_taxonomy';

		$register_function( 'pa_color' );
		$register_function( 'pa_brand' );
