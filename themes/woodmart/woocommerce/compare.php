...
<head>
    ...
    <<?php echo $title_tag; ?>><?php _e( 'Product Comparison', 'woodmart' ) ?></<?php echo $title_tag; ?>>
...
<h1>
    ...
    <?php if ( ! $is_iframe ) : ?><a class="close" href="#"><?php _e( 'Close window [X]', 'woodmart' ) ?></a><?php endif; ?>
</h1>
...
<table class="compare-list" cellpadding="0" cellspacing="0"<?php if ( empty( $products ) ) echo ' style="width:100%"' ?>>
    ...
    <?php if ( empty( $products ) ) : ?>
        ...
        <tr class="no-products">
            <td><?php _e( 'No products added in the compare table.', 'woodmart' ) ?></td>
        </tr>
        ...
        <tr class="remove">
            ...
            foreach( $products as $product_id => $product ) :
                ...
                <td class="<?php echo $product_class; ?>">
                    <a href="<?php echo add_query_arg( 'redirect', 'view', $this->remove_product_url( $product_id ) ) ?>" data-product_id="<?php echo $product_id; ?>"><?php _e( 'Remove', 'woodmart' ) ?> <span class="remove">x</span></a>
                </td>
                <?php
                ++$index;
            endforeach;
